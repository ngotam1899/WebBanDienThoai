...
var _CProgress = _interopRequireDefault(require("../progress/CProgress"));
...
var CWidgetProgress = function CWidgetProgress(props) {
  ...
  var classes = (0, _classnames["default"])('card', inverse ? [color && "bg-" + color, 'text-white'] : '', className);
  return /*#__PURE__*/_react["default"].createElement("div", _extends({
    ...
    className: "h4 m-0"
  }, header), text && /*#__PURE__*/_react["default"].createElement("div", null, text), children || /*#__PURE__*/_react["default"].createElement(_CProgress["default"], {
    color: !inverse ? color : '',
    value: value,
    className: "progress-xs my-3 mb-0 " + (inverse ? 'progress-white' : '')
  }), footer && /*#__PURE__*/_react["default"].createElement("small", {
    className: "text-muted"
  }, footer)));
};

CWidgetProgress.propTypes = process.env.NODE_ENV !== "production" ? {
