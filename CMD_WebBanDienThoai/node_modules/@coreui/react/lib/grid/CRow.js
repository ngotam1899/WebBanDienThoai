...
var CRow = function CRow(props) {
  ...
  var classes = (0, _classnames["default"])(className, !gutters ? 'no-gutters' : null, alignHorizontal ? "justify-content-" + alignHorizontal : null, alignVertical ? "align-" + alignVertical : null, form ? 'form-row' : 'row');
...
CRow.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  alignHorizontal: _propTypes["default"].string,
  alignVertical: _propTypes["default"].string
} : {};
CRow.defaultProps = {
  tag: 'div',
  gutters: true
