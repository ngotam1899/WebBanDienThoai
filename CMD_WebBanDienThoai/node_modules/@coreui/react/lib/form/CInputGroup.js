...
var CInputGroup = function CInputGroup(props) {
  ...
  var classes = (0, _classnames["default"])('input-group', size && "input-group-" + size, className);
...
CInputGroup.propTypes = process.env.NODE_ENV !== "production" ? {
