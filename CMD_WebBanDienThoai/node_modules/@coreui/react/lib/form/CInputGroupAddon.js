...
exports.CInputGroupPrepend = exports.CInputGroupAppend = void 0;
...
var CInputGroupAddon = function CInputGroupAddon(props) {
  ...
  var classes = (0, _classnames["default"])('input-group-' + (prepend ? 'prepend' : 'append'), className);
...
CInputGroupAddon.propTypes = process.env.NODE_ENV !== "production" ? {
...
var CInputGroupAppend = function CInputGroupAppend(props) {
  return /*#__PURE__*/_react["default"].createElement(CInputGroupAddon, _extends({}, props, {
    prepend: false
  }));
};
