...
var CEmbedItem = function CEmbedItem(props) {
  ...
  var classes = (0, _classnames["default"])(className, 'embed-responsive-item');
...
CEmbedItem.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  type: _propTypes["default"].oneOf(['iframe', 'embed', 'video', 'object', 'img'])
} : {};
CEmbedItem.defaultProps = {
  tag: 'iframe'
};
var _default = CEmbedItem;
