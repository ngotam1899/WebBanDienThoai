...
var CNav = function CNav(props) {
  ...
  var classes = (0, _classnames["default"])('nav', vertical && verticalClass, (_classNames = {}, _classNames["nav-" + variant] = variant, _classNames['nav-justified'] = justified, _classNames['nav-fill'] = fill, _classNames["card-header-" + variant] = inCard && variant, _classNames), className);
...
CNav.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  variant: _propTypes["default"].oneOf(['', 'tabs', 'pills']),
  ...
  inCard: _propTypes["default"].bool
} : {};
CNav.defaultProps = {
  tag: 'ul'
};
