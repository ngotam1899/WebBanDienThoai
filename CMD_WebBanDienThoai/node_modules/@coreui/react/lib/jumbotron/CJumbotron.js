...
var CJumbotron = function CJumbotron(props) {
  ...
  var classes = (0, _classnames["default"])(className, 'jumbotron', fluid ? 'jumbotron-fluid' : false);
...
CJumbotron.propTypes = process.env.NODE_ENV !== "production" ? {
