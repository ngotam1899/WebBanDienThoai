...
var CCardGroup = function CCardGroup(props) {
  ...
  var classes = (0, _classnames["default"])("card-" + (columns ? 'columns' : deck ? 'deck' : 'group'), className);
...
CCardGroup.propTypes = process.env.NODE_ENV !== "production" ? {
