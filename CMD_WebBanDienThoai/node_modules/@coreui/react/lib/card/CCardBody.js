...
var CCardBody = function CCardBody(props) {
  ...
  var classes = (0, _classnames["default"])(className, 'card-body', align ? "text-" + align : false, textColor ? "text-" + textColor : false, color ? "bg-" + color : false, borderColor ? "border-" + borderColor : false);
...
CCardBody.propTypes = process.env.NODE_ENV !== "production" ? _extends({
