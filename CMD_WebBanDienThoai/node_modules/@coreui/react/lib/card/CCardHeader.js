...
var CCardHeader = function CCardHeader(props) {
  ...
  var classes = (0, _classnames["default"])(className, 'card-header', align ? "text-" + align : false, textColor ? "text-" + textColor : false, color ? "bg-" + color : false, borderColor ? "border-" + borderColor : false);
...
CCardHeader.propTypes = process.env.NODE_ENV !== "production" ? _extends({
...
}, _CCard.sharedPropTypes) : {};
CCardHeader.defaultProps = {
  tag: 'header'
};
var _default = CCardHeader;
