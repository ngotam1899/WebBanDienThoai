...
var CCarouselItem = function CCarouselItem(props) {
  ...
  if (!animate || state[0] === null) {
    var itemClasses = (0, _classnames["default"])('carousel-item', isIn && 'active', className);
  ...
  return /*#__PURE__*/_react["default"].createElement(_reactTransitionGroup.Transition, {
    ...
    var itemClasses = (0, _classnames["default"])('carousel-item', isActive && 'active', directionClassName, orderClassName, className);
    return /*#__PURE__*/_react["default"].createElement("div", _extends({
      className: itemClasses,
      ref: ref
    }, attributes), children);
